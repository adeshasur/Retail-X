...
public class ShellViewModel : ObservableObject
{
    ...
    public ShellViewModel(AuthService authService, ProductService productService, SaleService saleService, Action logout)
    {
        ...
        NavigateSalesCommand = new RelayCommand(() => CurrentModule = new PlaceholderViewModel("Sales History", "Completed sales, invoice lookup, held bills and receipt workflows will live here."));
    ...
    public string AppName => "NexaTill POS by CodaWix";
    ...
    public RelayCommand NavigateSalesCommand { get; }
